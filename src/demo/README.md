...
NOTE that in particular for windows (.bat), it may be necessary to run the script twice, closing and reopening a new terminal session between executions that effectively install and run.
